...
<head>
    ...
    <script src="../onlinemalljs/person/order.js"></script>
    <script>
        function messages() {
            alert("卖家已经收到消息，请耐心等待卖家发货")
        }
    </script>
</head>
                ...
                <div class="am-tabs am-tabs-d2 am-margin" data-am-tabs>
                    ...
                    <div class="am-tabs-bd">
                        ...
                        <div class="am-tab-panel am-fade" id="tab3">
                            ...
                            　　　　　　　　　　　　
                            <div class="order-main">
                                <div class="order-list" id="WaitOutOrder">
                        ...
                        <div class="am-tab-panel am-fade" id="tab4">
                            ...
                            <div class="order-main">
                                <div class="order-list" id="WaitInOrder">
                        ...
                        <div class="am-tab-panel am-fade" id="tab5">
                            ...
                            <div class="order-main">
                                <div class="order-list" id="WaitEvaluateOrder">
                                    <!--不同状态的订单	-->
