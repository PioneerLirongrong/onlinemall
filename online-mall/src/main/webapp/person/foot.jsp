...
<head>
    ...
    <script src="../onlinemalljs/person/foot.js"></script>
</head>
                            ...
                            <%--<div class="goods-pic">--%>
                                <%--<div class="goods-pic-box">--%>
                                    <%--<p class="goods-pic-link" target="_blank" style="cursor: pointer">--%>
                                        <%--<img src="../images/TB1_pic.jpg_200x200.jpg" class="goods-img"></p>--%>
                                <%--</div>--%>
                            <%--</div>--%>

                            <%--<div class="goods-attr">--%>
                                <%--<div class="good-title">--%>
                                    <%--<a class="title" style="cursor: pointer" target="_blank">意大利费列罗进口食品巧克力零食24粒 进口巧克力食品</a>--%>
                                <%--</div>--%>
