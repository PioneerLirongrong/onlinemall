...
public class OnlinemallGoodsCookedFood implements Serializable {
    private String id;
    ...
    private String cookedfoodtype;

    private String cookedfoodbrand;

    private String saveway;

    private Integer delinetime;

    private Integer cookedfoodcount;
    ...
    public String getCookedfoodtype() {
        return cookedfoodtype;
    }

    public void setCookedfoodtype(String cookedfoodtype) {
        this.cookedfoodtype = cookedfoodtype;
    }

    public String getCookedfoodbrand() {
        return cookedfoodbrand;
    }

    public void setCookedfoodbrand(String cookedfoodbrand) {
        this.cookedfoodbrand = cookedfoodbrand;
    }
    ...
    public Integer getCookedfoodcount() {
        return cookedfoodcount;
    }

    public void setCookedfoodcount(Integer cookedfoodcount) {
        this.cookedfoodcount = cookedfoodcount;
    }
    ...
    public boolean equals(Object that) {
        ...
        OnlinemallGoodsCookedFood other = (OnlinemallGoodsCookedFood) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCookedfoodtype() == null ? other.getCookedfoodtype() == null : this.getCookedfoodtype().equals(other.getCookedfoodtype()))
            && (this.getCookedfoodbrand() == null ? other.getCookedfoodbrand() == null : this.getCookedfoodbrand().equals(other.getCookedfoodbrand()))
            ...
            && (this.getCookedfoodcount() == null ? other.getCookedfoodcount() == null : this.getCookedfoodcount().equals(other.getCookedfoodcount()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCookedfoodtype() == null) ? 0 : getCookedfoodtype().hashCode());
        result = prime * result + ((getCookedfoodbrand() == null) ? 0 : getCookedfoodbrand().hashCode());
        result = prime * result + ((getSaveway() == null) ? 0 : getSaveway().hashCode());
        result = prime * result + ((getDelinetime() == null) ? 0 : getDelinetime().hashCode());
        result = prime * result + ((getCookedfoodcount() == null) ? 0 : getCookedfoodcount().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", cookedfoodtype=").append(cookedfoodtype);
        sb.append(", cookedfoodbrand=").append(cookedfoodbrand);
        sb.append(", saveway=").append(saveway);
        sb.append(", delinetime=").append(delinetime);
        sb.append(", cookedfoodcount=").append(cookedfoodcount);
