...
public class OnlinemallGoodsDrinking implements Serializable {
    private String id;
    ...
    public String getDrinkingtsize() {
        return drinkingtsize;
    }

    public void setDrinkingtsize(String drinkingtsize) {
        this.drinkingtsize = drinkingtsize;
    }

    public Integer getAlcoholdegree() {
        return alcoholdegree;
    }

    public void setAlcoholdegree(Integer alcoholdegree) {
    ...
    public Integer getDrinkingcount() {
        return drinkingcount;
    }

    public void setDrinkingcount(Integer drinkingcount) {
    ...
    public boolean equals(Object that) {
        ...
        OnlinemallGoodsDrinking other = (OnlinemallGoodsDrinking) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getDrinkingtype() == null ? other.getDrinkingtype() == null : this.getDrinkingtype().equals(other.getDrinkingtype()))
            && (this.getDrinkbrand() == null ? other.getDrinkbrand() == null : this.getDrinkbrand().equals(other.getDrinkbrand()))
            && (this.getDrinkingtsize() == null ? other.getDrinkingtsize() == null : this.getDrinkingtsize().equals(other.getDrinkingtsize()))
            && (this.getAlcoholdegree() == null ? other.getAlcoholdegree() == null : this.getAlcoholdegree().equals(other.getAlcoholdegree()))
            ...
            && (this.getDrinkingcount() == null ? other.getDrinkingcount() == null : this.getDrinkingcount().equals(other.getDrinkingcount()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDrinkingtype() == null) ? 0 : getDrinkingtype().hashCode());
        result = prime * result + ((getDrinkbrand() == null) ? 0 : getDrinkbrand().hashCode());
        result = prime * result + ((getDrinkingtsize() == null) ? 0 : getDrinkingtsize().hashCode());
        result = prime * result + ((getAlcoholdegree() == null) ? 0 : getAlcoholdegree().hashCode());
        result = prime * result + ((getSaveway() == null) ? 0 : getSaveway().hashCode());
        result = prime * result + ((getDelinetime() == null) ? 0 : getDelinetime().hashCode());
        result = prime * result + ((getDrinkingcount() == null) ? 0 : getDrinkingcount().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", drinkingtype=").append(drinkingtype);
        sb.append(", drinkbrand=").append(drinkbrand);
        sb.append(", drinkingtsize=").append(drinkingtsize);
        sb.append(", alcoholdegree=").append(alcoholdegree);
        sb.append(", saveway=").append(saveway);
        sb.append(", delinetime=").append(delinetime);
        sb.append(", drinkingcount=").append(drinkingcount);
